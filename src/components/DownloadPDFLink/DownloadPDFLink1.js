...
import { DocumentLayout1, RenderLists1 }  from '../index';
...
class DownloadPDFLink1 extends Component {
    ...
    return (
        <Button
          ...
          size="large">
           ...
           <PDFDownloadLink
             document={DocumentLayout1(styles, this.props.name)}
...
export default DownloadPDFLink1;
